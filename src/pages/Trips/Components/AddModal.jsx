...
import { X, Save, Calendar, Clock, MapPin, Bus, User, Route } from 'lucide-react';
...
export const CreateTripModal = ({ isOpen, onClose, onSave }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.schedule_departure_time) newErrors.schedule_departure_time = 'L\'heure de départ est requise';
        if (!formData.schedule_arrival_time) newErrors.schedule_arrival_time = 'L\'heure d\'arrivée est requise';
        ...
        if (formData.schedule_departure_time && formData.schedule_arrival_time) {
            if (formData.schedule_departure_time >= formData.schedule_arrival_time) {
                newErrors.schedule_arrival_time = 'L\'heure d\'arrivée doit être après l\'heure de départ';
            }
        }
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            const newTrip = {
                ...formData,
                trip_id: Date.now(), // ID temporaire
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-6 border-b">
                    <h2 className="text-xl font-semibold text-gray-800">Nouveau Trajet</h2>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    {/* Troisième ligne - Date et Statut */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-2">
