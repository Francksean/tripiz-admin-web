        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center space-y-4 lg:space-y-0">
                <div className="flex-1">
                    ...
                    <p className="text-gray-600 mt-1 text-sm">Bienvenue sur votre
                        plateforme de gestion TRIPIZ</p>
                    <div className="flex items-center space-x-4 mt-3">
                        ...
                        <span
                            className="text-xs sm:text-sm xl:text-base text-green-600 font-medium">Système en ligne</span>
                    </div>
                </div>
            ...
            <div
                className="grid grid-cols-2 lg:grid-cols-4 gap-3 xl:gap-6 mb-4 xl:mb-8">
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center justify-between mb-2 sm:mb-3">
                                <div
                                    className={`w-8 h-8 sm:w-10 sm:h-10 xl:w-12 xl:h-12 bg-gradient-to-br ${stat.gradient} rounded-lg sm:rounded-xl flex items-center justify-center shadow-md group-hover:scale-105 transition-transform duration-300`}
                                >
                                    <Icon className="w-4 h-4 sm:w-5 sm:h-5 xl:w-6 xl:h-6 text-white"/>
                                </div>
                                <div
                                    className={`flex items-center space-x-1 px-2 py-0.5 sm:px-2.5 rounded-full text-[10px] sm:text-xs font-medium ${
                    ...
                    <div className="space-y-2 sm:space-y-3 xl:space-y-4 max-h-52 xl:max-h-64 2xl:max-h-72 overflow-y-auto">
                        {recentActivities.map((activity) => {
                            ...
                            return (
                                <div
                                    key={activity.id}
                                    className="flex items-start space-x-2 sm:space-x-3 p-2 sm:p-2.5 rounded-lg sm:rounded-xl hover:bg-gray-50 transition-colors duration-200"
                                >
                                    <div
                                        className={`w-7 h-7 sm:w-8 sm:h-8 xl:w-9 xl:h-9 rounded-md sm:rounded-lg flex items-center justify-center shadow-sm flex-shrink-0 ${
                                            activity.type === 'user'
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 xl:p-5 shadow-md border border-gray-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-6 gap-3 sm:gap-4">
                    {buses.map((bus) => (
                        <div
                            key={bus.id}
                            className="border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 hover:shadow-md transition bg-gradient-to-br from-white to-gray-50 min-h-[180px] sm:min-h-[200px]"
                        >
